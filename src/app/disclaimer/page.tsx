    ...
    >
      <TextArea>
        ...
        <p>
          ...
          app are entirely fictional. Any resemblance to real persons, living or
          dead, or real entities, is purely coincidental. The narratives,
        ...
        <p>
          ...
          represent real-world data. Any similarities to actual data, entities,
          or individuals are coincidental and unintended. This web app does not
          aim to provide factual representations or advice, and should not be
          used as such in any legal, financial, or decision-making contexts.
        </p>
        <p>
          By using this web app, you acknowledge that the content is intended
          for fictional and hypothetical purposes and agree not to interpret any
          element as factual or based on real-world events, organizations, or
          people.
        </p>
      </TextArea>
    </Container>
