    ...
    >
      <TextArea>
        ...
        <p>
          ...
          situations where the outcome of one person&apos;s decision depends on
        ...
        <p>
          ...
          <Modal triggerText="in the 1940s">
            John von Neumann and Oskar Morgenstern authored the &apos;Theory of
            Games and Economic Behavior&apos;, published in 1944. It is
        ...
        <ul>
          <li>
            <strong>Zero-Sum Games:</strong> A situation where one player&apos;s
            gain is exactly equal to the other player&apos;s loss. In zero-sum
            games, the total resources available remain constant.
          </li>
          <li>
        ...
        <p>
          We&apos;ll apply game theory to understand competitors&apos; actions,
          customer behavior, and how to craft strategies that maximize our own
          outcomes while anticipating the moves of others.
        </p>
      </TextArea>
    </Container>
  );
