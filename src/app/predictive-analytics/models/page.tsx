    ...
    >
      <TextArea>
        ...
        <p>
          ...
          intervene early to retain customers. Here are common variables used in
          churn prediction models:
        </p>
        <ul>
          <li>
            <strong>Frequency of Usage:</strong> How often a customer interacts
            with your service. High frequency usually indicates greater
            engagement and lower churn risk.
          </li>
          <li>
