    ...
    >
      <TextArea>
        ...
        <p>
          ...
          three different churn prediction models to see how they calculate the
        ...
        {selectedModel === "Logistic Regression" && (
          <p>
            ...
            a sigmoid function to output a probability between 0 and 100. It
            assumes linear relationships between variables and churn risk.
          </p>
        )}
        ...
        {selectedModel === "XGBoost" && (
          <p>
            ...
            ones. It&apos;s known for its high performance with larger datasets.
          </p>
        )}
      </TextArea>
    </Container>
