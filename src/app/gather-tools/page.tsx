    ...
    >
      <TextArea>
        ...
        <p>
          ...
          strategist, Lingming, will walk us through some of the main concepts.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Backward Induction</strong>: Predicting optimal decisions by
            reasoning backward from the final outcome.
          </li>
          <li>
